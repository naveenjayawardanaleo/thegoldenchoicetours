...
<section class="tours-section py-5">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="row">
                <?php $__currentLoopData = $vehicle; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-4 mb-5">
                        <div class="card vehicle-card h-100 shadow-sm ">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-text"><?php echo $tour->Description; ?></div>

                                <div class="text-left mt-3">
                                    <a href="https://wa.me/+94774666301?text=The%20Golden%20Choice%20Tours%2C%20I%20would%20like%20to%20book%20a%20<?php echo e($tour->Title); ?>" class="btn btn-success " target="_blank"> <i class="fa fa-brands fa-whatsapp"></i> Whats App</a>
...
<?php endif; ?>
<?php /**PATH /home1/nadeeshb/thegoldenchoicetours.com/resources/views/vehicle.blade.php ENDPATH**/ ?>