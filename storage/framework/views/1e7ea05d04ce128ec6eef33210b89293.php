...
<?php $component->withAttributes([]); ?>
                    ...
                    <div class="col-md-12">
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Multi Day Tours</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <section class="section ">
        <div class="container">
            ...
            <h1 class="title  text-center  ">Multi Day Tours</h1>
...
<?php endif; ?><?php /**PATH /home1/nadeeshb/thegoldenchoicetours.com/resources/views/multiday-tours.blade.php ENDPATH**/ ?>