        ...
        <section>
            <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    ...
                    <?php $__currentLoopData = $slider; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $sli): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>


                        <div class="carousel-item <?php echo e($index == 0 ? 'active' : ''); ?>">
                            <img src="<?php echo e(asset('storage/' .$sli->image_path)); ?>" class="d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block">
                                <h3><?php echo e($sli->Title); ?></h3>
                                <p class="fs-5 "><?php echo e($sli->ShortDescription); ?></p>
                            </div>
                        </div>
...
<?php endif; ?>
<?php /**PATH /home1/nadeeshb/thegoldenchoicetours.com/resources/views/home.blade.php ENDPATH**/ ?>