<x-front-layout>
    ...
    <x-section>
        ...
        <div class="col-md-6">
            ...
            <img src="{{ asset('images/Explore the Ancient Cities.jpg') }}" alt="">
    ...
    <x-section>
        ...
        <div class="col-md-6">
            ...
            <img src="{{ asset('images/Discover Stunning Beaches.jpg') }}" alt="">
    ...
    <x-section>
        ...
        <div class="col-md-6">
            ...
            <img src="{{ asset('images/Immerse Yourself in Cultural Festivals.jpg') }}" alt="">
    ...
    <x-section>
        ...
        <div class="col-md-6">
            ...
            <img src="{{ asset('images/Visit Local Craft Markets.jpg') }}" alt="">
