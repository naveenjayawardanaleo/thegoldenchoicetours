    ...
    <section class="section">
        <div class="container">
            <div class="row ">
                <div class="col-md-6 ">
                    <div class="row ">
                        <img src="{{ asset('images/Hotel Recommendations.jpg') }}" class="w-100" alt="">
                    </div>
                </div>
                <div class="col-md-6">
    ...
    <section class="section">
        <div class="container">
            <div class="row ">
                <div class="col-md-6 ">
                    <div class="row ">
                        <img src="{{ asset('images/Transport Arrangements.jpg') }}" class="w-100" alt="">
                    </div>
                </div>
                <div class="col-md-6">
    ...
    <section class="section">
        <div class="container">
            <div class="row ">
                <div class="col-md-6 ">
                    <div class="row ">
                        <img src="{{ asset('images/Meal Arrangements.jpg') }}" class="w-100" alt="">
                    </div>
                </div>
                <div class="col-md-6">
